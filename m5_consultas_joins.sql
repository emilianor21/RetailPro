...
-- Hallazgos:
-- Se construyó una vista integrada de ventas, clientes, productos y territorios para su uso en Power BI.
-- Se identificaron clientes y productos sin actividad comercial mediante LEFT JOIN.
-- Se consolidó la facturación por canal utilizando UNION ALL y GROUP BY.